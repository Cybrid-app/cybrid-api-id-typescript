...
export interface ApplicationIdpModel {
     ...
     * @memberof ApplicationIdpModel
     */
    scopes: Array<ApplicationIdpModelScopesEnum>;
    /**
 ...
 * @enum {string}
 */
export enum ApplicationIdpModelScopesEnum {
    ...
    Rewardsexecute = 'rewards:execute',
