...
export class OrganizationApplicationsIdpApi extends BaseAPI {
    ...
    createOrganizationApplication({ postOrganizationApplicationIdpModel }: CreateOrganizationApplicationRequest, opts?: OperationOpts): Observable<RawAjaxResponse<ApplicationWithSecretIdpModel>>
    createOrganizationApplication({ postOrganizationApplicationIdpModel }: CreateOrganizationApplicationRequest, opts?: OperationOpts): Observable<ApplicationWithSecretIdpModel | RawAjaxResponse<ApplicationWithSecretIdpModel>> {
    ...
    listOrganizationApplications({ page, perPage }: ListOrganizationApplicationsRequest, opts?: OperationOpts): Observable<RawAjaxResponse<ApplicationListIdpModel>>
    listOrganizationApplications({ page, perPage }: ListOrganizationApplicationsRequest, opts?: OperationOpts): Observable<ApplicationListIdpModel | RawAjaxResponse<ApplicationListIdpModel>> {
