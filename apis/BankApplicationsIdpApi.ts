...
export interface CreateBankApplicationRequest {
    postBankApplicationIdpModel: PostBankApplicationIdpModel;
}

export interface DeleteBankApplicationRequest {
    clientId: string;
}

export interface GetBankApplicationRequest {
    clientId: string;
}

export interface ListBankApplicationsRequest {
    page?: number;
    perPage?: number;
    bankGuid?: string;
}

export interface UpdateBankApplicationRequest {
    clientId: string;
 ...
 * no description
 */
export class BankApplicationsIdpApi extends BaseAPI {

    /**
     * Creates a bank OAuth2 application.  Required scope: **bank_applications:execute**
     * Create bank application
     */
    createBankApplication({ postBankApplicationIdpModel }: CreateBankApplicationRequest): Observable<ApplicationWithSecretIdpModel>
    createBankApplication({ postBankApplicationIdpModel }: CreateBankApplicationRequest, opts?: OperationOpts): Observable<AjaxResponse<ApplicationWithSecretIdpModel>>
    createBankApplication({ postBankApplicationIdpModel }: CreateBankApplicationRequest, opts?: OperationOpts): Observable<ApplicationWithSecretIdpModel | AjaxResponse<ApplicationWithSecretIdpModel>> {
        throwIfNullOrUndefined(postBankApplicationIdpModel, 'postBankApplicationIdpModel', 'createBankApplication');
        ...
        const headers: HttpHeaders = {
            ...
            ...(this.configuration.accessToken != null
                ? { Authorization: typeof this.configuration.accessToken === 'function'
                    ? this.configuration.accessToken('oauth2', ['bank_applications:execute'])
        ...
        return this.request<ApplicationWithSecretIdpModel>({
            url: '/api/bank_applications',
            method: 'POST',
            headers,
            body: postBankApplicationIdpModel,
        }, opts?.responseOpts);
    };
     ...
     */
    deleteBankApplication({ clientId }: DeleteBankApplicationRequest): Observable<void>
    deleteBankApplication({ clientId }: DeleteBankApplicationRequest, opts?: OperationOpts): Observable<void | AjaxResponse<void>>
    deleteBankApplication({ clientId }: DeleteBankApplicationRequest, opts?: OperationOpts): Observable<void | AjaxResponse<void>> {
        throwIfNullOrUndefined(clientId, 'clientId', 'deleteBankApplication');
        ...
        return this.request<void>({
            url: '/api/bank_applications/{client_id}'.replace('{client_id}', encodeURI(clientId)),
            method: 'DELETE',
            headers,
        }, opts?.responseOpts);
    };
     ...
     */
    getBankApplication({ clientId }: GetBankApplicationRequest): Observable<ApplicationIdpModel>
    getBankApplication({ clientId }: GetBankApplicationRequest, opts?: OperationOpts): Observable<AjaxResponse<ApplicationIdpModel>>
    getBankApplication({ clientId }: GetBankApplicationRequest, opts?: OperationOpts): Observable<ApplicationIdpModel | AjaxResponse<ApplicationIdpModel>> {
        throwIfNullOrUndefined(clientId, 'clientId', 'getBankApplication');
        ...
        const headers: HttpHeaders = {
            ...
            ...(this.configuration.accessToken != null
                ? { Authorization: typeof this.configuration.accessToken === 'function'
                    ? this.configuration.accessToken('oauth2', ['bank_applications:read'])
                    : this.configuration.accessToken }
                : undefined
            ),
        };
     ...
     */
    listBankApplications({ page, perPage, bankGuid }: ListBankApplicationsRequest): Observable<ApplicationListIdpModel>
    listBankApplications({ page, perPage, bankGuid }: ListBankApplicationsRequest, opts?: OperationOpts): Observable<AjaxResponse<ApplicationListIdpModel>>
    listBankApplications({ page, perPage, bankGuid }: ListBankApplicationsRequest, opts?: OperationOpts): Observable<ApplicationListIdpModel | AjaxResponse<ApplicationListIdpModel>> {
     ...
     */
    updateBankApplication({ clientId, patchApplicationIdpModel }: UpdateBankApplicationRequest): Observable<ApplicationIdpModel>
    updateBankApplication({ clientId, patchApplicationIdpModel }: UpdateBankApplicationRequest, opts?: OperationOpts): Observable<AjaxResponse<ApplicationIdpModel>>
    updateBankApplication({ clientId, patchApplicationIdpModel }: UpdateBankApplicationRequest, opts?: OperationOpts): Observable<ApplicationIdpModel | AjaxResponse<ApplicationIdpModel>> {
        throwIfNullOrUndefined(clientId, 'clientId', 'updateBankApplication');
        throwIfNullOrUndefined(patchApplicationIdpModel, 'patchApplicationIdpModel', 'updateBankApplication');
        ...
        const headers: HttpHeaders = {
            ...
            ...(this.configuration.accessToken != null
                ? { Authorization: typeof this.configuration.accessToken === 'function'
                    ? this.configuration.accessToken('oauth2', ['bank_applications:write'])
                    : this.configuration.accessToken }
                : undefined
            ),
        };
