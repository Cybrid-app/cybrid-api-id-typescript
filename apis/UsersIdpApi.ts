...
export interface UpdateUserRequest {
    userGuid: string;
    patchUserIdpModel: PatchUserIdpModel;
}
...
export class UsersIdpApi extends BaseAPI {
     ...
     * Disable User
     */
    disableUser({ userGuid }: DisableUserRequest): Observable<void>
    disableUser({ userGuid }: DisableUserRequest, opts?: OperationOpts): Observable<void | AjaxResponse<void>>
    disableUser({ userGuid }: DisableUserRequest, opts?: OperationOpts): Observable<void | AjaxResponse<void>> {
        throwIfNullOrUndefined(userGuid, 'userGuid', 'disableUser');
        ...
        return this.request<void>({
            url: '/api/users/{user_guid}'.replace('{user_guid}', encodeURI(userGuid)),
            method: 'DELETE',
            headers,
        }, opts?.responseOpts);
    };
     ...
     * Get User
     */
    getUser({ userGuid }: GetUserRequest): Observable<UserIdpModel>
    getUser({ userGuid }: GetUserRequest, opts?: OperationOpts): Observable<AjaxResponse<UserIdpModel>>
    getUser({ userGuid }: GetUserRequest, opts?: OperationOpts): Observable<UserIdpModel | AjaxResponse<UserIdpModel>> {
        throwIfNullOrUndefined(userGuid, 'userGuid', 'getUser');
     ...
     * Update User
     */
    updateUser({ userGuid, patchUserIdpModel }: UpdateUserRequest): Observable<UserIdpModel>
    updateUser({ userGuid, patchUserIdpModel }: UpdateUserRequest, opts?: OperationOpts): Observable<AjaxResponse<UserIdpModel>>
    updateUser({ userGuid, patchUserIdpModel }: UpdateUserRequest, opts?: OperationOpts): Observable<UserIdpModel | AjaxResponse<UserIdpModel>> {
        throwIfNullOrUndefined(userGuid, 'userGuid', 'updateUser');
        throwIfNullOrUndefined(patchUserIdpModel, 'patchUserIdpModel', 'updateUser');
